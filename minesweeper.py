# -*- coding: utf-8 -*-
"""
Εργασία 11: Γράψτε ένα πρόγραμμα το οποίο θα εκτυπώνει στην οθόνη σωστά τυχαίες πίστες του γνωστού
παιχνιδιού ναρκαλιετής. Οι πίστες θα είναι 10x10 και θα έχουν όσες νάρκες δηλώσει ο χρήστης.
"""
...
mines = input("Enter number of mines(0-100): ")
